...
public class ColumnChartActivityTinggi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Grafik Tinggi Badan");
        ...
        cartesian.title("Tinggi Badan Posyandu");

        cartesian.yScale().minimum(0d);

        cartesian.yAxis(0).labels().format("10 Cm");
